    ...
    <div className="dark:text-white text-gray-800 min-h-screen mt-5 mb-5 space-y-5">
      ...
      <section className="mx-auto flex justify-between  rounded-2xl p-5 bg-[#fff7ed6e] dark:bg-[#261B25]">
        ...
        <ul className="list-disc list-inside space-y-3 text-lg">
          ...
          <li>Each user can participate only once per contest unless specified otherwise.</li>
        </ul>
        </div>
      </section>
      ...
      <section className="flex justify-between  rounded-2xl p-5 bg-[#fff7ed6e] dark:bg-[#261B25]">
        ...
        <ul className="list-disc list-inside space-y-3 text-lg">
          ...
          <li>Creators should provide clear and fair judging criteria for participants.</li>
          <li>Admins have the final authority on any disputes or rule clarifications.</li>
        </ul>
        </div>
      </section>
      ...
      <section className='bg-secondary dark:bg-[#261B25] rounded-2xl p-5'>
        ...
        <ul className="list-disc list-inside space-y-3 text-lg">
          ...
          <li>ContestHub and creators are not responsible for technical issues during submission.</li>
          <li>Winners’ achievements may be displayed publicly on the website.</li>
        </ul>
      </section>
    </div>
  );
