    ...
    <div className="rounded-2xl pt-5 pb-10">
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto rounded-2xl">
        ...
        <p className="md:text-lg text-center max-w-3xl mx-auto">
          Our goal is to create a vibrant platform where creativity meets
          opportunity. We enable users to join exciting contests, showcase
      ...
      <section className="py-20 px-6 bg-primary rounded-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className=" p-8 rounded-2xl shadow hover:scale-105 transition">
            ...
            <p>
              Contest Creators can easily create new contests with images,
              tasks, prizes, and deadlines.
            </p>
          </div>
          <div className=" p-8 rounded-2xl shadow hover:scale-105 transition">
            <h3 className="font-bold text-2xl mb-4">Join & Participate</h3>
            <p>
              Users can browse contests, pay entry fees, submit tasks, and track
              their progress.
            </p>
          </div>
          <div className=" p-8 rounded-2xl shadow hover:scale-105 transition">
            ...
            <p>
              Creators declare winners, and achievements are showcased to
